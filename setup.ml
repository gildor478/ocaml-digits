...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11e043d2fa1b0a107947d037414f8712) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-digits", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-digits", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["DigitsNum"; "DigitsBig_int"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "digits";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "digits";
                           InternalLibrary "digits-num"
                        ];
                      bs_build_tools =
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/digits";
                      doc_title = "API reference for Digits";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "\017.\210Y\n\227\131\136\235\177}\140\157\229\025\238";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
